...
nether.register_portal("lunar_portal", {
		...
		title = "Lunar Portal",
		book_of_portals_pagetext = [[Made of 21 moon portal blocks, and is constructed in the shape of a 3 × 3 platform with walls, or like a bowl. A finished platform is 2 blocks high, and 5 blocks wide at the widest in both directions.
This portal is different to the others, rather than acting akin to a doorway it appears to the eye more like a small pool of water which can be stepped into. Upon setting foot in the portal we found ourselves staring at Earth from the moon! We couldn't believe the sight! Astounding!]],
